...
async def gen_link_batch(bot, message):
    if " " not in message.text:
        return await message.reply("𝚄𝚂𝙴 𝙲𝙾𝚁𝚁𝙴𝙲𝚃 𝙵𝙾𝚁𝙼𝙰𝚃.\n𝙴𝚇𝙰𝙼𝙿𝙻𝙴 ›› <code>/batch https://telegram.dog/TeamEvamaria/10 https://telegram.dog/TeamEvamaria/20</code>.")
    ...
    if chat_id in FILE_STORE_CHANNEL:
        ...
        return await sts.edit(f"<b>⪼ 𝙷𝙴𝚁𝙴 𝙸𝚂 𝚈𝙾𝚄𝚁 𝙻𝙸𝙽𝙺 ›› https://telegram.dog/{temp.U_NAME}?start=DSTORE-{b_64}</b>")
